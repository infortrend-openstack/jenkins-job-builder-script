...
sed -i 's/dsvm-tempest-ift-driver-volume-test/infortrend-cinder-volume-iscsi/g' $FILE_ISCSI
...
sed -i 's/dsvm-tempest-ift-driver-volume-test/infortrend-cinder-volume-fc/g' $FILE_FIBRE
